---
title: "Cluster Generation Notes 2"
author: "Emily Raney"
date: "2022-11-17"
...
### Runs with positive separation values 

#### Run 1
3 clusters of equal size, separation value of 0.01, two non-noisy variables
...
#### Run 2
5 clusters of equal size, separation value of 0.01, two non-noisy variables
...
#### Run 3 
5 clusters of equal size, separation value of 0.25, two non-noisy variables
```{r}
...
#### Run 4
5 clusters of equal size, separation value of .5, two non-noisy variables 
```{r}
...
#### Run 5
5 clusters of equal size, separation value of 0.75, two non-noisy variables 
```{r}
...
#### Run 6
5 clusters of equal size, separation value of 0.99, two non-noisy variables 
```{r}
...
### Runs with negative separation values 
...
#### Run 9 
5 clusters of equal size, separation value of -0.50, two non-noisy variables
```{r}
...
### Clusters with positive separation values

#### Run 12
5 clusters of unequal size; there us a user-set range of values (10-50) but the resulting cluster sizes are random. Separation value of 0.01, two non-noisy variables. 

```{r}
genRandomClust(5, sepVal = 0.01, numNonNoisy = 2, clustszind = 2, rangeN = c(10, 50), numReplicate = 1, fileName = "run12") #set cluster sizes to be unequal [clustsizind = 2], with a range of values from 10-50 [rangeN = 10-50]; the sizes of each cluster can be found in the .log file. 
...
#### Run 13
5 clusters of unequal size; user-defined sizes for each cluster [clustszind = 3, clustSizes = c(3, 9, 12, 18, 50)]. Separation value of 0.01, two non-noisy variables. 

```{r}
genRandomClust(5, sepVal = 0.01, numNonNoisy = 2, clustszind = 3, clustSizes = c(3, 9, 12, 18, 50), numReplicate = 1, fileName = "run13") #set cluster sizes individually 
